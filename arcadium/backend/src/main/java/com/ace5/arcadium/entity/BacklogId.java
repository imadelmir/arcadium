...
/**
 * Chiave composta di {@link Backlog}: (user_id, app_id).
 *
 * Le componenti sono i valori delle FK verso app_user e games; il legame con le
 * associazioni @ManyToOne è realizzato in Backlog tramite @MapsId. Come richiede
...
public class BacklogId implements Serializable {
    ...
    public BacklogId(Long userId, Long appId) {
        this.userId = userId;
        this.appId = appId;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof BacklogId other)) return false;
